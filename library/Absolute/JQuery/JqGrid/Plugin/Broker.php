...
class Absolute_JQuery_JqGrid_Plugin_Broker extends Absolute_JQuery_JqGrid_Plugin_Abstract
{
    /**
     ...
     * Register a plugin.
     *
     * @param  Absolute_JQuery_JqGrid_Plugin_Abstract $plugin
     * @return Absolute_JQuery_JqGrid_Plugin_Broker
     */
    public function registerPlugin(Absolute_JQuery_JqGrid_Plugin_Abstract $plugin)
    {
    ...
    {
        if ($plugin instanceof Absolute_JQuery_JqGrid_Plugin_Abstract) {
     ...
     * @return false|Absolute_JQuery_JqGrid_Plugin_Abstract|array Returns false if none found, plugin if only one found, and array of plugins if multiple plugins of same class found
     */
     ...
     * @return void
     */
    public function setGrid(Absolute_JQuery_JqGrid $grid)
    {
        $this->_grid = $grid;
        return $this;
    }
    ...
    /**
     * Called before Absolute_JQuery_JqGrid sends response 
     *
     * @return void
     */
    ...
    /**
     * Called after Absolute_JQuery_JqGrid has generated response
     *
     * @return void
     */
    ...
    /**
     * Called before Absolute_JQuery_JqGrid renders
     * 
    ...
    /**
     * Called after Absolute_JQuery_JqGrid renders
     *
     * @return void
     */
