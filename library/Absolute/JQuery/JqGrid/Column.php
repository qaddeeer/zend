...
class Absolute_JQuery_JqGrid_Column
{
    /**
     ...
     * 
     * @return Absolute_JQuery_JqGrid_Column
     */
    public function setOption($name, $value)
    {
        
        if ($name == 'name' && isset($this->_options['name'])) {
            throw new Absolute_JQuery_JqGrid_Exception('The column name cannot be changed, as it has already been defined.');
        }
...
//        return htmlspecialchars($row[$this->getName()]);
