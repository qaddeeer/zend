...
/**
 * @see Absolute_JQuery_JqGrid_Column_Decorator_Abstract
 */
require_once 'Absolute/JQuery/JqGrid/Column/Decorator/Abstract.php';
...
class Absolute_JQuery_JqGrid_Column_Decorator_Link extends Absolute_JQuery_JqGrid_Column_Decorator_Abstract
{
    ...
    public function decorate()
    {
        if (! isset($this->_options['link'])) {
            throw new Absolute_JQuery_JqGrid_Exception('A valid link must be supplied.');
        }
