...
abstract class Absolute_JQuery_JqGrid_Column_Decorator_Abstract
{
    /**
     * Column Instance
     * 
     * @var $_column Absolute_JQuery_JqGrid_Column
     */
    protected $_column;

    public function __construct(Absolute_JQuery_JqGrid_Column $column)
    {
        $this->_column = $column;
    }
