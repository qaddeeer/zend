...
class Absolute_JQuery_JqGrid
{
     ...
     * @var Absolute_JQuery_JqGrid_Adaptor_Interface
     */
    ...
    /**
     * Instance of Absolute_JQuery_JqGrid_Plugin_Broker
     * 
     * @var Absolute_JQuery_JqGrid_Plugin_Broker
     */
    protected $_plugins;
     ...
     * Constructor.
     *
     * @param Absolute_JQuery_JqGrid_Adapter_Interface $adaptor
     * @param array $options
     */
    public function __construct($id, $adapter, array $options = array())
    {
        Zend_Paginator::addAdapterPrefixPath('Absolute_JQuery_JqGrid_Adapter', 'Absolute/JQuery/JqGrid/Adapter');
        
        if ($adapter instanceof Absolute_JQuery_JqGrid_Adapter_Interface) {
            $this->_adapter = $adapter;
        } else {
            throw new Absolute_JQuery_JqGrid_Exception('Absolute_JQuery_JqGrid only accepts instances of the type ' . 'Absolute_JQuery_JqGrid_Adapter_Interface');
        }
        $this->_id = $id;
        ...
        $this->_plugins = new Absolute_JQuery_JqGrid_Plugin_Broker();
        $this->_plugins->setGrid($this);
        
        $this->_plugins->registerPlugin(new Absolute_JQuery_JqGrid_Plugin_Pager());
    }
...
//        $this->_options['caption'] = ucwords(str_replace("_", "", $this->_id));
     ...
     * 
     * @param Absolute_JQuery_JqGrid_Column $column
     * @return Absolute_JQuery_JqGrid
     */
    ...
    public function render(Zend_View_Interface $view = null)
    {
        ...
        $view = $this->getView();
        $view->addHelperPath("Absolute/JQuery/JqGrid/View/Helper", "Absolute_JQuery_JqGrid_View_Helper");
...
//        $grid->total = $this->_paginator->getItemCountPerPage();
        $grid->total = $this->_paginator->getPages()->last;
