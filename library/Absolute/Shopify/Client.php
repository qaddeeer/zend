...
/**
 * Description of Absolute_Shopify_Client
 *
 * @author Qadeer Ahmad
 */
class Absolute_Shopify_Client {
    public $shop_domain;
    private $token;
    private $api_key;
    private $secret;
...
//        $this->name = "ShopifyClient";
        $this->name = "Absolute_Shopify_Client";
    ...
    public function call($method, $path, $params = array()) {
        ...
        if (isset($response['errors']) or ($this->last_response_headers['http_status_code'] >= 400)) {
            throw new Absolute_Shopify_Api_Exception($method, $path, $params, $this->last_response_headers, $response);
        }
    ...
    private function curlHttpApiRequest($method, $url, $query = '', $payload = '', $request_headers = array()) {
        ...
        if ($errno)
            throw new Absolute_Shopify_Curl_Exception($error, $errno);
